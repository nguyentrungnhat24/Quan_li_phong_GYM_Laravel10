<header class="admin-header" style="margin-bottom:0; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
    <nav class="navbar navbar-expand-lg" style="background: #219150; margin-bottom:0; min-height: 70px;">
        <div class="container-fluid px-4">
            <a class="navbar-brand fw-bold text-white d-flex align-items-center"
               style="font-size:2.5rem; letter-spacing:2.5px; padding: 0 20px; margin-right: 32px;" href="#">FITNESS</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarResponsive">
                <ul class="navbar-nav mb-2 mb-lg-0 gap-lg-4"
                    style="font-size:1.5rem; text-transform:uppercase; font-weight:700; letter-spacing:1px;">
